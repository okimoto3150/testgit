...
class Controller extends BaseController
{
    use AuthorizesRequests, DispatchesJobs, ValidatesRequests;
        ...
        public function checkout(Request $moji)
        {
            ...
            try {
                ...
                $strAccountid = $_SESSION["Accountid"];
            }
            catch (\Throwable $th) {
    ...
    {
        $strSql = "INSERT INTO password_resets VALUES('".$_SESSION["email"]."','".Hash::make($strToken)."','".date('Y-m-d H:i:s')."') ";
