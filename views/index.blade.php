    ...
    <div class="top-box">
        ...
        <section>
            <div class="index-first-section">
                ...
                <div class="tb">
                    <h2><img src="{{asset('/img/top/H2.png')}}" alt="タイトル画像"></h2>
                ...
                <div class="scroll-fade-row">
                    ...
                    <div class="faq-wrapper">
                        <div class="faq-box">
                            <div class="faq-q">
                                <div class="q-contents">
                                    <div><span class="lettar-q">Q</span><span class="question">一人で複数契約できますか？</span></div>
                                    <div class="open-icon">
                                        <div class="plus-img"><img src="{{asset('/img/top/plus.png')}}" alt=""></div>
                                        <div class="minus-img"><img src="{{asset('/img/top/minus.png')}}" alt=""></div>
                                    </div>
...
<!--    <form action="/ChargeController" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript" charset="UTF-8">
        sessionStorage.setItem('agency',((new URL(document.location)).searchParams).get("utm_campaign"));
        (function (config) {  
            config.urlCapture = { 
