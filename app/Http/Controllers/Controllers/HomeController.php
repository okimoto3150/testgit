...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $_SESSION('Accountid', $listAccount["Id"], $kigen);
        $_SESSION('name', $listAccount["Name"], $kigen);
        $_SESSION('AccountFirstName', $listAccount["Kokyakuseikanji__pc"], $kigen);
        $_SESSION('AccountLastName', $listAccount["Kokyakumeikanji__pc"], $kigen);
        $_SESSION('AccountFirstNameKana', $listAccount["Kokyakuseikana__pc"], $kigen);
        $_SESSION('AccountLastNameKana', $listAccount["Kokyakumeikana__pc"], $kigen);
        $_SESSION('birthday', $listAccount["Moushikomishaseinengappi__pc"], $kigen);
        $_SESSION('AccountEmail', $listAccount["PersonEmail"], $kigen);
        $_SESSION('AccountPhone', $listAccount["Phone"], $kigen);
        $_SESSION('yuubenbango', $listAccount["Yuubenbango__pc"], $kigen);
        $_SESSION('AccountState', $listAccount["state__c"], $kigen);
        $_SESSION('AccountCity', $listAccount["city__c"], $kigen);
        $_SESSION('Accountline2', $listAccount["line2__c"], $kigen);
